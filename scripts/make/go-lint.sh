...
# OpenBSD support it.
#
# TODO(d.kolyshev):  Add github.com/AdguardTeam/golibs/log.
blocklist_imports() {
...
# TODO(d.kolyshev):  Re-enable G602 once securego/gosec#1406 is fixed.
run_linter gosec --exclude G602 --fmt=golint --quiet ./...
